...
function sceUsbbdRegister(drv: PUsbDriver): integer; external;

function sceUsbbdUnregister(drv: PUsbDriver): integer; external;

function sceUsbbdClearFIFO(endp: PUsbEndpoint): integer; external;

function sceUsbbdReqCancelAll(endp: PUsbEndpoint): integer; external;

function sceUsbbdStall(endp: PUsbEndpoint): integer; external;

function sceUsbbdReqSend(req: PUsbdDeviceReq): integer; external;

function sceUsbbdReqRecv(req: UsbdDeviceReq): integer; external;
