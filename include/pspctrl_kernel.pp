 ...
 *)
procedure sceCtrl_driver_7CA723DC(mask: uint32; atype: uint32); cdecl; external;

function sceCtrl_driver_5E77BC8A(mask: uint32): int32; cdecl; external;

function sceCtrl_driver_5C56C779(no: int32; mask: uint32; cb: Tcb; arg: pointer): int32; cdecl; external;
