...
function sceKernelInitApitype: integer; external;

function sceKernelInitFileName: Pchar; external;

function sceKernelBootForm: integer; external;

function InitForKernel_7233B5BC: integer; external;
